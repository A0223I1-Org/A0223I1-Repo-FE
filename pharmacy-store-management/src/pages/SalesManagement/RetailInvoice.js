        ...
        try {
            ...
            if (isFirstTime) {
                ...
                setFormData({
                    ...
                    medicineListF: [{
                        medicineIdF: medicineId,
                        medicineNameF: medicineName,
                        unitF: unit,
                        quantityF: quantity,
                        retailPriceF: retailPrice
                    }],
        ...
        <>
                ...
                <section className="main">
                    <div className="main-left">
                        <nav className="sidebar">
                            <ul>
                                <li style={{textAlign: "center", fontSize: "22.8px", padding: " 0px 3px"}}>Chọn nhanh
                                </li>
                                <li>
                                            ...
                                            <ResetFormContext.Provider value={resetForm}>
                                                <Form onSubmit={handleSubmit} className="form">
                                                    <div className="secondary-infomation-1">
                                                        <div>
                                                            <label htmlFor="invoiceId" style={{marginTop: '6.75px'}}>Số
                                                                phiếu: </label>
                                                            <input type="text" id="invoiceId" name="invoiceId"
                                                                   style={{marginLeft: '24px', marginRight: '30px'}}
                                                                   placeholder="TT00001" readOnly/>

                                                        </div>
                                                        <div>
                                                            <label htmlFor="dateCreate" style={{marginTop: '6.75px'}}>Ngày
                                                                lập: </label>
                                                            <input type="date" id="dateCreate" name="dateCreate"
                                                                   style={{marginLeft: '28.5px', marginRight: '30px'}}
                                                                   value={values.dateCreate}
                                                                   onChange={handleChange}/>
                                                            <div className='erros-mess'>
                                                                <ErrorMessage name="dateCreate" component="div"
                                                                              className="error-message"/>
                                                            </div>
                                                        </div>
                                                        <div>
                                                            <label htmlFor="note" style={{marginTop: '6.75px'}}>Ghi chú
                                                                : </label>
                                                            <textarea id="note" name="note" rows="1.5" cols="30"
                                                                      placeholder="Ghi chú" style={{
                                                    ...
                                                    <div className="secondary-infomation-2">
                                                        <div className="employee">
                                                            ...
                                                            <input type="text" name="employeeName" id="employeeName"
                                                                   list="employeeList" placeholder="Tên nhân viên"
                                                        ...
                                                        <div className="customer">
                                                            <label htmlFor="customerName" aria-required="true">Khách
                                                                hàng: </label>
                                                            <input type="text" name="customerName" id="customerName"
                                                                   list="customerList" placeholder="Tên khách hàng"
                                                        ...
                                                        <div className="disease-symptoms">
                                                            ...
                                                            <input type="text" name="systomName" id="systomName"
                                                                   list="symptomList" placeholder="Tên triệu chứng"
                                                    ...
                                                    <div className="main-infomation">
                                                        <div className="disease-symptoms">
                                                            ...
                                                            <input type="text" name="medicineName" id="medicineName"
                                                                   list="medicineList" placeholder="Tên thuốc"
                                                            ...
                                                            <div className='erros-mess'>
                                                                <ErrorMessage name="medicineName" component="div"
                                                                              className="error-message"/>
                                                            </div>
                                                        </div>
                                                        <div>
                                                            <label htmlFor="quantity" style={{marginTop: '6.75px'}}>Số
                                                                lượng: </label>
                                                            <input type="number" id="quantity" name="quantity"
                                                                   style={{marginLeft: '32.5px', marginRight: '30px'}}
                                                                   placeholder="0"
                        ...
                        <span>
                          <i className="bi bi-file-earmark-ruled"></i> Nhập thuốc từ toa sẵn
                                                    ...
                                                    <button type="submit" className="btn btn-primary" style={{
                                                        ...
                                                        marginTop: '16px',
                                                        marginLeft: '34.5px'
                                                    }}><i className="bi bi-patch-plus"></i>Thêm
                                                    </button>
                            ...
                            <div className="action2">
                                <button type="button" className="btn btn-primary"
                                        onClick={() => handlePayment(resetForm)}>
            <span className="em-1">
          ...
          <span className="em-1">
            <i className="bi bi-x-circle"></i>
                                ...
                                <button type="button" className="btn btn-info"><span className="em-1"><i
                                    className="bi bi-printer"></i></span>In phiếu
                                </button>
