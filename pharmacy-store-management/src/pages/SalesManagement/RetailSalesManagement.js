                ...
                <section className="main">
                                            ...
                                            <Form action="">
                                                <div className="date-time-inputs">
                                                    <div className='input-date-time'>
                                                        <div>
                                                            ...
                                                            <Field type="date" name="fromDate" as="input" style={{
                                                                height: "40px",
                                                                minWidth: "200px",
                                                                maxWidth: "55px"
                                                    ...
                                                    <div className='input-date-time'>
                                                        <div>
                                                            ...
                                                            <Field type="date" name="toDate" as="input" style={{
                                                                height: "40px",
                                                                minWidth: "200px",
                                                                maxWidth: "55px"
                                                            }} className="form-control"/>
                                                    ...
                                                    <div className='input-date-time'>
                                                        <div>
                                                            ...
                                                            <Field type="time" name="fromTime" as="input" style={{
                                                                height: "40px",
                                                                minWidth: "200px",
                                                                maxWidth: "55px"
                                                            }} className="form-control"/>
                                                        ...
                                                        <div>
                                                            <ErrorMessage name="fromTime" component="div"
                                                                          className="error-message"/>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className='input-date-time'>
                                                        <div>
                                                            ...
                                                            <Field type="time" name="toTime" as="input" style={{
                                                                height: "40px",
                                                                minWidth: "200px",
                                                                maxWidth: "55px"
                                                            }} className="form-control"/>
                                                        ...
                                                        <div>
                                                            <ErrorMessage name="toTime" component="div"
                                                                          className="error-message"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="show-sort-button">
                                                    <div className="show">
                                                        ...
                                                        <Field name="displayField" as="select" onChange={handleChange}
                                                               style={{
                                                                   height: "40px",
                                                                   minWidth: "200px",
                                                                   maxWidth: "55px",
                                                    ...
                                                    <div className="sort" style={{marginLeft: '15px'}}>
                                                        ...
                                                        <Field name="sortField" as="select" onChange={handleChange}
                                                               style={{
                                                                   height: "40px",
                                                                   minWidth: "200px",
                                                                   maxWidth: "55px"
                    ...
                    <span className="em-1">
                        <i className="bi bi-plus-circle"></i>
                                ...
                                <a className="btn btn-info"><span className="em-1"><i
                                    className="bi bi-pencil-square"></i></span> Sửa</a>

                                <a data-bs-toggle="modal" data-bs-target="#delete" className="btn btn-danger"><span
                                    className="em-1"><i className="bi bi-x-circle"></i></span> Xoá</a>

                                <a className="btn btn-secondary"><span className="em-1"><i
                                    className="bi bi-arrow-left-square"></i></span> Trở về</a>
                            </div>
                        </div>
                    </div>
                </section>
